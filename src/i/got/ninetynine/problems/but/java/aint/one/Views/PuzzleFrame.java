...
public class PuzzleFrame extends javax.swing.JFrame{
    ...
    public PuzzleFrame (){
        ...
        puzzleLabels = new HashMap<JLabel, Point> ( 9 );
        ...
        PuzzleController.setUpdatePiecesListener ( new UpdatePiecesListener (){
    ...
    private void initComponents() {
        ...
        lbl1.getAccessibleContext().setAccessibleName("img1");
